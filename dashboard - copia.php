                            ...
                            <div class="d-flex">
                                <div class="dropdown">
                                    <a class="nav-link dropdown-toggle py-1" href="#" role="button"
                                        data-bs-toggle="dropdown" style="font-size: 0.9rem;">
                                        <!-- Reducido el tamaño de fuente y padding -->
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <li><a class="dropdown-item"
                                                href="dashboard.php?page=settings">Configuración</a>
                                        </li>
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                                        <li><a class="dropdown-item" href="dashboard.php?logout=1">Cerrar Sesión</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="button-container mb-3" style="width: 400px; margin: 0; text-align: left;">
                                    <button type="button" class="btn btn-success d-none" id="addNewContact">
                                ...
                                <div class="contact-scroll-container"
                                    ...
                                    <div class="d-flex flex-column align-items-start" id="contactsContainer"
                                        ...
                                        <div class="py-5 d-none" id="noContactsMessage" style="width: 100%;">
                                            ...
                                            <button class="btn btn-sm btn-success mt-2" id="btnNoContactsAddEmpty">
